...
const SubscriberVideosSection = () => {
  return (
    <Suspense fallback={<SubscriberVideosSectionSkeleton />}>
      <ErrorBoundary fallback={<p>Error</p>}>
        <SubscriberVideosSectionSuspense />
      </ErrorBoundary>
    </Suspense>
  );
};

const SubscriberVideosSectionSkeleton = () => {
  return (
...
const SubscriberVideosSectionSuspense = () => {
  const [videos, query] =
...
export default SubscriberVideosSection;
